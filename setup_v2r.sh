...
# Путь к конфигу V2Ray с клиентами
V2RAY_CLIENTS_FILE = "/etc/v2ray/conf/clients.json"
...
# -------------------------------------------------------
# Обновление V2Ray (/etc/v2ray/conf/clients.json)
# -------------------------------------------------------
...
cat > /etc/v2ray/conf/clients.json <<'EOF'
{
  "inbounds": [
    {
      "tag": "vmess_ws",
...
chown root:v2api /etc/v2ray/conf/clients.json
chmod 664 /etc/v2ray/conf/clients.json
